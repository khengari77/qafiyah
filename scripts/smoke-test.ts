...
const URLS = [
  ...
  `${BASE}/poets?page=2`,
  `${BASE}/poets/abn-rumi`,
  `${BASE}/poets?era=jahili`,
  `${BASE}/poets?q=%D8%A7%D9%84%D9%85%D8%AA%D9%86%D8%A8%D9%8A`,
  `${BASE}/meters`,
  `${BASE}/meters/albasit`,
  `${BASE}/rhymes/meem`,
  `${BASE}/themes`,
  `${BASE}/themes/almutafarriqat`,
  `${BASE}/collections/almuallaqat`,
  `${BASE}/?q=%D9%8A%D8%A7+%D8%B1%D8%A8`,
  `${BASE}/?q=%D9%8A%D8%A7+%D8%B1%D8%A8&match_type=exact&rhyme_ids=10`,

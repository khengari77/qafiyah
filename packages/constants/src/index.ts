...
export const DEV_PREVIEW_PORT = 3000;
export const DEV_WEB_URL = 'http://localhost:4321';
...
export const DATABASE_DUMPS_URL = 'https://github.com/alwalxed/qafiyah/tree/main/data/datasets';

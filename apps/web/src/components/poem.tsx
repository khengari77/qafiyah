...
export default function Poem({ clearTitle, data, verses, verseCount }: PoemProps) {
  return (
      ...
      <div className="w-full flex flex-col gap-12 justify-center items-center">
        ...
        <header className="flex justify-center items-center flex-col gap-4 xxs:gap-6 text-center w-full">
          <div className="flex flex-col gap-2 xx:gap-4">
            <h1 className="text-lg xxs:text-2xl md:text-3xl font-bold text-zinc-800">
              {clearTitle}
            </h1>
          ...
          <div className="flex flex-col items-center w-full">
            <div className="w-full xxs:w-8/12 md:w-9/12 lg:w-8/12 xl:w-6/12">
              {verses.map((verse, index) => (
                ...
                >
                  <p
                    className="text-sm md:text-xl lg:text-2xl text-right w-full"
                    lang="ar"
                    dir="rtl"
                  >
                    {verse[0]}
                  ...
                  <p
                    className="text-sm md:text-xl lg:text-2xl text-left w-full"
                    lang="ar"
                    dir="rtl"
                  >
                    {verse[1]}
